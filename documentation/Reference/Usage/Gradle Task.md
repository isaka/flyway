...
**Note:** Flyway v14 will require Java 21.
...
[Config files](https://documentation.red-gate.com/flyway/flyway-concepts/flyway-projects) are supported by the Flyway Gradle plugin.
