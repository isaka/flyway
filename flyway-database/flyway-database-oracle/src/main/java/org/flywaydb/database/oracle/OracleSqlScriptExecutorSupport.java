...
public interface OracleSqlScriptExecutorSupport extends Plugin {
    DefaultSqlScriptExecutor getOracleSqlScriptExecutor(final OracleDatabaseType databaseType,
